                                        ...
                                        <table id="table1" class="table table-bordered text-center">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th scope="col" class="" width="22%">Medicine</th>
                                                ...
                                                <tr id="1">
                                                    ...
                                                    <td colspan="1" class="">
                                                        ...
                                                        <label for="batch_id" class="mb-2"></label>
                                                            <input type="text" name="batch_id[]" id="batch_id1" placeholder="BI-01" class="form-control batch_id">
                                                        </div>
                                                    </td>
                                                    <td colspan="1">
                                                        <div class="input-group">
        ...
        $("#dynamicAddRemove").append('\
            <tr id="'+[i]+'">\
                ...
                <td colspan="1" class="">\
                    <div class="input-group">\
                    <label for="batch_id" class="mb-2"></label>\
                        <input type="text" name="batch_id[]" id="batch_id'+[i]+'" placeholder="BI-01" class="form-control batch_id">\
                    </div>\
                </td>\
                <td colspan="1">\
                    <div class="input-group">\
