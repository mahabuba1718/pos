...
<head>
    ...
    <link href="assets/backend/img/Pill.png" rel="icon" />
    <title>Invoice</title>
        ...
        <header>
            <div class="row align-items-center">
                <div class="col-sm-7 text-center text-sm-start mb-3 mb-sm-0">
                    <img id="logo" src="assets/backend/img/medi.png" style="width: 100px;" title="Logo" alt="logo" />
                    <h4>Medicine POS</h4>
                </div>
                    ...
                    <div class="table-responsive">
                        <table class="table mb-0">
                            ...
                            <tfoot class="card-footer">
                                <tr>
                                    <td colspan="5" class="text-end border-bottom-0"><strong>Sub Total:</strong></td>
                                    <td class="text-end border-bottom-0">250.00</td>
                                </tr>
                                <tr>
                                    <td colspan="5" class="text-end border-bottom-0"><strong>Vat:</strong></td>
                                    <td class="text-end border-bottom-0">5.00</td>
                                </tr>
                                <tr>
                                    <td colspan="5" class="text-end border-bottom-0"><strong>Discount:</strong></td>
                                ...
                                <tr>
                                    <td colspan="5" class="text-end border-bottom-0"><strong>Paid:</strong></td>
                                ...
                                <tr>
                                    <td colspan="5" class="text-end border-bottom-0"><strong>Due:</strong></td>
                                    <td class="text-end border-bottom-0">0.00</td>
                                </tr>
                            </tfoot>
